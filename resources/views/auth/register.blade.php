                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telefono" type="text" class="form-control{{ $errors->has('telefono') ? ' is-invalid' : '' }}" name="telefono" value="{{ old('felefono') }}" required>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fecha_bautismo" type="date" class="form-control{{ $errors->has('fecha_bautismo') ? ' is-invalid' : '' }}" name="fecha_bautismo" value="{{ old('fecha_bautismo') }}" required>
